...
<div>
    ...
    <?php
        ...
        $questionQuery = "SELECT * FROM questions WHERE status = 'active' LIMIT 6,1";
    ...
    <p id="description">There's no wrong answer. We can help you achieve your goals even if you don't have much time.</p>
    ...
    <form action="save-result.php" method="post" onsubmit="return validateForm()">
        ...
        <footer>
        <input type="hidden" name="prev_step" value="create4">
